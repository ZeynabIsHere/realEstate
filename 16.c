...
typedef struct cresidentialList PropertyNode;
PropertyNode* readResidentialListFromFile(char* ResidentialPropertyList)
...
void showPropertiesUnderPrice(struct cresidentialList *head, char *maxPrice)
{
    ...
    while(current!=NULL)
    {
          if(strcmp(current->priceRage, maxPrice) < 0)
        {
            ...
            printf("%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c", 220, 220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220);
        }
        current=current->link;
    }
}
int showPropertiesInfrastructureCheck(int *head, int infrastructureCheck)
{
    struct cresidentialList *current;
    current=head;
    while(current!=NULL)
    {
        if(infrastructureCheck==current->infrastructure)
        {
            printf("%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n", current->fn, current->ln, current->fan, current->mon, current->idn, current->phn, current->propertyType, current->propertySize, current->infrastructure, current->bedRooms, current->bathRooms, current->priceRage, current->floor, current->adress, current->neighbourhood, current->district, current->amenities, current->receptionRoom, current->serviceCharge, current->validation);
            printf("%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c", 220, 220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220);
        }
...
char secondMenu()
{
        ...
        //this one is the main part of this project that user can use it most of the time, the reportage
    {
        ...
        if(pChoice==1)
        {
            ...
            {
                int vol1;
                vol1=atoi(cresidentialList.infrastructure);
                char m;
                struct  cresidentialList *head;
                head=readResidentialListFromFile(m);
                int infrastructureCheck;
                printf("Enter infrastructure: ");
                scanf("%d", &infrastructureCheck);
        ...
        if(pChoice==2)
        {
            ...
            printf("\n2.List based on district");
            printf("\n3.List based on age of structure");
            printf("\n4.List based on infrastructure");
            printf("\n5.List based on price");
            printf("\n6.List based on bedrooms");
            printf("\n7.List based on floor\n");
            int sChoice;
            scanf("%d", &sChoice);
            system("cls");
            if(sChoice==1)
    ...
    if(pChoice==4)
    {
        ...
        printf("\n\n7.Total value ");
        printf("\n\n8.Employees actions");
        printf("\n\n8.Clients time checking");
        printf("\n\n8.Employees time checking");
        scanf("%d", &vChoice);
        system("cls");
    }
}
