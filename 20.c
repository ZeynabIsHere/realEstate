...
typedef struct cresidentialList rNode;
rNode* readResidentialListForRentFromFile(char* residentialListRent)
//this action actually does read the file and create one linked list, to save the informations, it makes one or many nodes and returns propertyNodes
{
    FILE *file=fopen("residentialListRent.txt", "r");
    if (file==NULL)
    {
        printf("Error opening file\n");
        return NULL;
...
void showPropertiesUnderPriceForRent(struct residentialListRent *head, char *maxPriceResRent)
//in this function we just can report the lists that they are under the max price(which the user gave us)
{
    struct residentialListRent *current;
    current=head;
    while(current!=NULL)
    {
        if(strcmp(current->priceRage, maxPriceResRent)>0)
            //i get the user price string and compare it to the prices in the file, then show the under prices.
        {
            printf("\nFirst Name:%s\nLast Name:%s\nFather Name:%s\nMother Name:%s\nID Number:%s\nPhone Number:%s\nProperty Type:%s\nProperty Size:%s\nInfrastructure:%s\nBedroom:%s\nBath Room:%s\nPrice Rage:%s\nFloor:%s\nAdress:%s\nNeighbourhood:%s\nDistrict:%s\nAmenities:%s\nReception Room:%s\nService Charge:%s\nValidation:%s\n", current->fn, current->ln, current->fan, current->mon, current->idn, current->phn, current->propertyType, current->propertySize, current->infrastructure, current->bedRooms, current->bathRooms, current->priceRage, current->floor, current->adress, current->neighbourhood, current->district, current->amenities, current->receptionRoom, current->serviceCharge,current->validation);
            printf("\n%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n", 220, 220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220);
...
void showPropertiesInfrastructureCheckForRent(struct residentialListRent *head, char *infrastructureCheckRent)
//this function is for infrastructures that they are under the one which user gave us.
{
    struct residentialListRent *current;
    current=head;
    while(current!=NULL)
    {
        if(strcmp(current->infrastructure,infrastructureCheckRent)>0)
            // it compares between users price and the prices in the file.
        {
            printf("First Name:%s\nLast Name:%s\nFather Name:%s\nMother Name:%s\nID Number:%s\nPhone Number:%s\nProperty Type:%s\nProperty Size:%s\nInfrastructure:%s\nBedroom:%s\nBath Room:%s\nPrice Rage:%s\nFloor:%s\nAdress:%s\nNeighbourhood:%s\nDistrict:%s\nAmenities:%s\nReception Room:%s\nService Charge:%s\nValidation:%s\n", current->fn, current->ln, current->fan, current->mon, current->idn, current->phn, current->propertyType, current->propertySize, current->infrastructure, current->bedRooms, current->bathRooms, current->priceRage, current->floor, current->adress, current->neighbourhood, current->district, current->amenities, current->receptionRoom, current->serviceCharge, current->validation);
            printf("\n%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n", 220, 220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220);
...
void showPropertiesDistrictCheckRent(struct residentialListRent *head, char *districtCheckRent)
//this function is for checking district
{
    struct residentialListRent *current;
    current=head;
    while(current!=NULL)
    {
        if(strcmp(current->district, districtCheckRent) > 0)
            //if the users district equals district in file, it shows.
        {
            printf("First Name:%s\nLast Name:%s\nFather Name:%s\nMother Name:%s\nID Number:%s\nPhone Number:%s\nProperty Type:%s\nProperty Size:%s\nInfrastructure:%s\nBedroom:%s\nBath Room:%s\nPrice Rage:%s\nFloor:%s\nAdress:%s\nNeighbourhood:%s\nDistrict:%s\nAmenities:%s\nReception Room:%s\nService Charge:%s\nValidation:%s\n", current->fn, current->ln, current->fan, current->mon, current->idn, current->phn, current->propertyType, current->propertySize, current->infrastructure, current->bedRooms, current->bathRooms, current->priceRage, current->floor, current->adress, current->neighbourhood, current->district, current->amenities, current->receptionRoom, current->serviceCharge, current->validation);
            printf("\n%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n", 220, 220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220);
...
void showPropertiesBedroomCheckRent(struct residentialListRent *head, char *bedroomCheckRent)
//this function is for number of the bed rooms
{
    struct residentialListRent *current;
    current=head;
    while(current!=NULL)
    {
        if(strcmp(current->bedRooms,bedroomCheckRent)>0)
            //if the users bedrooms equals bedrooms in file, it shows.
        {
            printf("First Name:%s\nLast Name:%s\nFather Name:%s\nMother Name:%s\nID Number:%s\nPhone Number:%s\nProperty Type:%s\nProperty Size:%s\nInfrastructure:%s\nBedroom:%s\nBath Room:%s\nPrice Rage:%s\nFloor:%s\nAdress:%s\nNeighbourhood:%s\nDistrict:%s\nAmenities:%s\nReception Room:%s\nService Charge:%s\Validation:%s\n", current->fn, current->ln, current->fan, current->mon, current->idn, current->phn, current->propertyType, current->propertySize, current->infrastructure, current->bedRooms, current->bathRooms, current->priceRage, current->floor, current->adress, current->neighbourhood, current->district, current->amenities, current->receptionRoom, current->serviceCharge, current->validation);
            printf("\n%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n", 220, 220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220);
        }
        current=current->link;
    }
}
void showPropertiesFloorCheckRent(struct residentialListRent *head, char *floorCheckRent)
//this function is for number of the floors
{
    struct residentialListRent *current;
    current=head;
    while(current!=NULL)
    {
        if(strcmp(current->floor,floorCheckRent)>0)
            //if the users floor equals floor in file, it shows.
        {
            printf("First Name:%s\nLast Name:%s\nFather Name:%s\nMother Name:%s\nID Number:%s\nPhone Number:%s\nProperty Type:%s\nProperty Size:%s\nInfrastructure:%s\nBedroom:%s\nBath Room:%s\nPrice Rage:%s\nFloor:%s\nAdress:%s\nNeighbourhood:%s\nDistrict:%s\nAmenities:%s\nReception Room:%s\nService Charge:%s\nValidation:%s\n", current->fn, current->ln, current->fan, current->mon, current->idn, current->phn, current->propertyType, current->propertySize, current->infrastructure, current->bedRooms, current->bathRooms, current->priceRage, current->floor, current->adress, current->neighbourhood, current->district, current->amenities, current->receptionRoom, current->serviceCharge, current->validation);
            printf("\n%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n", 220, 220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220);
...
typedef struct commercialListRent comNode;
comNode* readCommercialListFromFileRent(char* CommercialPropertyListForRent)
//this action actually does read the file and create one linked list, to save the informations, it makes one or many nodes and returns propertyNodes
{
    FILE *file=fopen("CommercialPropertyListForRent.txt", "r");
    if (file==NULL)
    {
        printf("Error opening file\n");
        return NULL;
    ...
    comNode *head=NULL;
    comNode *current=NULL;

    while(!feof(file))
    {
        comNode *newNode=(comNode*)malloc(sizeof(comNode));
        //here, it just scan everything in the file and \n is here to help going to next line
        if(fscanf(file, "%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n", newNode->fn, newNode->ln, newNode->fan, newNode->mon, newNode->idn, newNode->phn, newNode->propertyType, newNode->propertySize, newNode->infrastructure, newNode->rooms, newNode->bathRooms, newNode->priceRage, newNode->floor, newNode->adress, newNode->neighbourhood, newNode->district, newNode->amenities, newNode->receptionRoom, newNode->serviceCharge,newNode->shops, newNode->validation) != 21)
        {
            free(newNode);
...
void showPropertiesUnderPriceComRent(struct commercialListRent *head, char *maxPriceComRent)
//in this function we just can report the lists that they are under the max price(which the user gave us)
{
    struct commercialListRent *current;
    current=head;
    while(current!=NULL)
    {
        if(strcmp(current->priceRage, maxPriceComRent)>0)
            //i get the user price string and compare it to the prices in the file, then show the under prices.
        {
            printf("\nFirst Name:%s\nLast Name:%s\nFather Name:%s\nMother Name:%s\nID Number:%s\nPhone Number:%s\nProperty Type:%s\nProperty Size:%s\nInfrastructure:%s\nBedroom:%s\nBath Room:%s\nPrice Rage:%s\nFloor:%s\nAdress:%s\nNeighbourhood:%s\nDistrict:%s\nAmenities:%s\nReception Room:%s\nService Charge:%s\nValidation:%s\n", current->fn, current->ln, current->fan, current->mon, current->idn, current->phn, current->propertyType, current->propertySize, current->infrastructure, current->rooms, current->bathRooms, current->priceRage, current->floor, current->adress, current->neighbourhood, current->district, current->amenities, current->receptionRoom, current->serviceCharge,current->shops, current->validation);
            printf("\n%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n", 220, 220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220);
...
void showPropertiesInfrastructureCheckComRent(struct commercialListRent *head, char *infrastructureCheckComRent)
//this function is for infrastructures that they are under the one which user gave us.
{
    struct commercialListRent *current;
    current=head;
    while(current!=NULL)
    {
        if(strcmp(current->infrastructure,infrastructureCheckComRent)>0)
            // it compares between users price and the prices in the file.
        {
            printf("\nFirst Name:%s\nLast Name:%s\nFather Name:%s\nMother Name:%s\nID Number:%s\nPhone Number:%s\nProperty Type:%s\nProperty Size:%s\nInfrastructure:%s\nBedroom:%s\nBath Room:%s\nPrice Rage:%s\nFloor:%s\nAdress:%s\nNeighbourhood:%s\nDistrict:%s\nAmenities:%s\nReception Room:%s\nService Charge:%s\nValidation:%s\n", current->fn, current->ln, current->fan, current->mon, current->idn, current->phn, current->propertyType, current->propertySize, current->infrastructure, current->rooms, current->bathRooms, current->priceRage, current->floor, current->adress, current->neighbourhood, current->district, current->amenities, current->receptionRoom, current->serviceCharge,current->shops, current->validation);
            printf("\n%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n", 220, 220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220);
...
void showPropertiesDistrictCheckComRent(struct commercialListRent *head, char *districtCheckComRent)
//this function is for checking district
{
    struct commercialListRent *current;
    current=head;
    while(current!=NULL)
    {
        if(strcmp(current->district, districtCheckComRent)>0)
            //if the users district equals district in file, it shows.
        {
            printf("\nFirst Name:%s\nLast Name:%s\nFather Name:%s\nMother Name:%s\nID Number:%s\nPhone Number:%s\nProperty Type:%s\nProperty Size:%s\nInfrastructure:%s\nBedroom:%s\nBath Room:%s\nPrice Rage:%s\nFloor:%s\nAdress:%s\nNeighbourhood:%s\nDistrict:%s\nAmenities:%s\nReception Room:%s\nService Charge:%s\nValidation:%s\n", current->fn, current->ln, current->fan, current->mon, current->idn, current->phn, current->propertyType, current->propertySize, current->infrastructure, current->rooms, current->bathRooms, current->priceRage, current->floor, current->adress, current->neighbourhood, current->district, current->amenities, current->receptionRoom, current->serviceCharge,current->shops, current->validation);
            printf("\n%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n", 220, 220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220);
...
void showPropertiesShopCheckRent(struct commercialListRent *head, char *shopCheckRent)
//this function is for number of the bed rooms
{
    struct commercialListRent *current;
    current=head;
    while(current!=NULL)
    {
        if(strcmp(current->shops,shopCheckRent)>0)
            //if the users bedrooms equals bedrooms in file, it shows.
        {
            printf("\nFirst Name:%s\nLast Name:%s\nFather Name:%s\nMother Name:%s\nID Number:%s\nPhone Number:%s\nProperty Type:%s\nProperty Size:%s\nInfrastructure:%s\nBedroom:%s\nBath Room:%s\nPrice Rage:%s\nFloor:%s\nAdress:%s\nNeighbourhood:%s\nDistrict:%s\nAmenities:%s\nReception Room:%s\nService Charge:%s\nValidation:%s\n", current->fn, current->ln, current->fan, current->mon, current->idn, current->phn, current->propertyType, current->propertySize, current->infrastructure, current->rooms, current->bathRooms, current->priceRage, current->floor, current->adress, current->neighbourhood, current->district, current->amenities, current->receptionRoom, current->serviceCharge,current->shops, current->validation);
            printf("\n%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n", 220, 220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220);
...
void showPropertiesFloorCheckComRent(struct commercialListRent *head, char *floorCheckComRent)
//this function is for number of the floors
{
    struct commercialListRent *current;
    current=head;
    while(current!=NULL)
    {
        if(strcmp(current->floor,floorCheckComRent)>0)
            //if the users floor equals floor in file, it shows.
        {
            printf("\nFirst Name:%s\nLast Name:%s\nFather Name:%s\nMother Name:%s\nID Number:%s\nPhone Number:%s\nProperty Type:%s\nProperty Size:%s\nInfrastructure:%s\nBedroom:%s\nBath Room:%s\nPrice Rage:%s\nFloor:%s\nAdress:%s\nNeighbourhood:%s\nDistrict:%s\nAmenities:%s\nReception Room:%s\nService Charge:%s\nValidation:%s\n", current->fn, current->ln, current->fan, current->mon, current->idn, current->phn, current->propertyType, current->propertySize, current->infrastructure, current->rooms, current->bathRooms, current->priceRage, current->floor, current->adress, current->neighbourhood, current->district, current->amenities, current->receptionRoom, current->serviceCharge,current->shops, current->validation);
            printf("\n%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n", 220, 220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220);
...
typedef struct countrylandListRent couNode;
couNode* readCountryLandFromFileRent(char* CountryLandPropertyListForRent)
//this action actually does read the file and create one linked list, to save the informations, it makes one or many nodes and returns propertyNodes
{
    FILE *file=fopen("CountryLandPropertyListForRent.txt", "r");
    if (file==NULL)
    {
        printf("Error opening file\n");
        return NULL;
    ...
    couNode *head=NULL;
    couNode *current=NULL;

    while(!feof(file))
    {
        couNode *newNode=(couNode*)malloc(sizeof(couNode));
        //here, it just scan everything in the file and \n is here to help going to next line
        if(fscanf(file, "%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n", newNode->fn, newNode->ln, newNode->fan, newNode->mon, newNode->idn, newNode->phn, newNode->propertyType, newNode->propertySize, newNode->infrastructure, newNode->rooms, newNode->bathRooms, newNode->priceRage, newNode->adress, newNode->neighbourhood, newNode->district, newNode->amenities, newNode->harvest, newNode->serviceCharge,newNode->validation) != 19)
        {
            free(newNode);
...
void showPropertiesUnderPriceCouRent(struct countrylandListRent *head, char *maxPriceCouRent)
//in this function we just can report the lists that they are under the max price(which the user gave us)
{
    struct countrylandListRent *current;
    current=head;
    while(current!=NULL)
    {
        if(strcmp(current->priceRage, maxPriceCouRent)>0)
            //i get the user price string and compare it to the prices in the file, then show the under prices.
        {
            printf("\nFirst Name:%s\nLast Name:%s\nFather Name:%s\nMother Name:%s\nID Number:%s\nPhone Number:%s\nProperty Type:%s\nProperty Size:%s\nInfrastructure:%s\nRooms:%s\nBath Room:%s\nPrice Rage:%s\nAdress:%s\nNeighbourhood:%s\nDistrict:%s\nAmenities:%s\nHarvest:%s\nService Charge:%s\nValidation:%s\n", current->fn, current->ln, current->fan, current->mon, current->idn, current->phn, current->propertyType, current->propertySize, current->infrastructure, current->rooms, current->bathRooms, current->priceRage, current->adress, current->neighbourhood, current->district, current->amenities, current->harvest, current->serviceCharge,current->validation);
            printf("\n%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n", 220, 220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220);
...
void showPropertiesInfrastructureCheckCouRent(struct countrylandListRent *head, char *infrastructureCheckCouRent)
//this function is for infrastructures that they are under the one which user gave us.
{
    struct countrylandListRent *current;
    current=head;
    while(current!=NULL)
    {
        if(strcmp(current->infrastructure,infrastructureCheckCouRent)>0)
            // it compares between users price and the prices in the file.
        {
            printf("\nFirst Name:%s\nLast Name:%s\nFather Name:%s\nMother Name:%s\nID Number:%s\nPhone Number:%s\nProperty Type:%s\nProperty Size:%s\nInfrastructure:%s\nRooms:%s\nBath Room:%s\nPrice Rage:%s\nAdress:%s\nNeighbourhood:%s\nDistrict:%s\nAmenities:%s\nHarvest:%s\nService Charge:%s\nValidation:%s\n", current->fn, current->ln, current->fan, current->mon, current->idn, current->phn, current->propertyType, current->propertySize, current->infrastructure, current->rooms, current->bathRooms, current->priceRage, current->adress, current->neighbourhood, current->district, current->amenities, current->harvest, current->serviceCharge,current->validation);
            printf("\n%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n", 220, 220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220);
...
void showPropertiesDistrictCheckCouRent(struct countrylandListRent *head, char *districtCheckCouRent)
//this function is for checking district
{
    struct countrylandListRent *current;
    current=head;
    while(current!=NULL)
    {
        if(strcmp(current->district, districtCheckCouRent)>0)
            //if the users district equals district in file, it shows.
        {
            printf("\nFirst Name:%s\nLast Name:%s\nFather Name:%s\nMother Name:%s\nID Number:%s\nPhone Number:%s\nProperty Type:%s\nProperty Size:%s\nInfrastructure:%s\nRooms:%s\nBath Room:%s\nPrice Rage:%s\nAdress:%s\nNeighbourhood:%s\nDistrict:%s\nAmenities:%s\nHarvest:%s\nService Charge:%s\nValidation:%s\n", current->fn, current->ln, current->fan, current->mon, current->idn, current->phn, current->propertyType, current->propertySize, current->infrastructure, current->rooms, current->bathRooms, current->priceRage, current->adress, current->neighbourhood, current->district, current->amenities, current->harvest, current->serviceCharge,current->validation);
            printf("\n%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n", 220, 220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220);
...
void showPropertiesHarvestCheckRent(struct countrylandListRent *head, char *harvestCheckRent)
//this function is for harvest
{
    struct countrylandListRent *current;
    current=head;
    while(current!=NULL)
    {
        if(strstr(current->harvest,harvestCheckRent)==0)
            //if the users harvest equals harvest in file, it shows.
        {
            printf("\nFirst Name:%s\nLast Name:%s\nFather Name:%s\nMother Name:%s\nID Number:%s\nPhone Number:%s\nProperty Type:%s\nProperty Size:%s\nInfrastructure:%s\nRooms:%s\nBath Room:%s\nPrice Rage:%s\nAdress:%s\nNeighbourhood:%s\nDistrict:%s\nAmenities:%s\nHarvest:%s\nService Charge:%s\nValidation:%s\n", current->fn, current->ln, current->fan, current->mon, current->idn, current->phn, current->propertyType, current->propertySize, current->infrastructure, current->rooms, current->bathRooms, current->priceRage, current->adress, current->neighbourhood, current->district, current->amenities, current->harvest, current->serviceCharge,current->validation);
            printf("\n%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n", 220, 220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220,220);
...
char secondMenu()
{
    ...
    char choice, bChoice, cChoice, mChoice, nChoice,pChoice, xChoice, vChoice,xxChoice, firstName[60], lastName[160];
    printf("Please enter a number and click the enter to continue.\n");
    printf("\033[0;36m");
        ...
        //this one is the main part of this project that user can use it most of the time, the reportage
    {
        ...
        printf("\n4.Residential property(for rent).");
        printf("\n5.Commercial property(for rent).");
        printf("\n6.Country land(for rent).");
        printf("\n7.Admin access.");
        scanf("\n%d", &pChoice);
        system("cls");
        if(pChoice==1)
        ...
        if(pChoice==4)
        {
            printf("Reportage of Residential properties for rent. (Please enter the maximum amount):");
            printf("\n\n1.The number of the Residential properties.");
            printf("\n2.List based on price");
            printf("\n3.List based on infrastructure");
            printf("\n4.List based on district");
            ...
            if(xxChoice==1)
            {
                FILE*file=fopen("ResidentialPropertyListForRent.txt", "r");
                if(!file)
                {
                    printf("Error opening the file");
                }
                struct residentialListRent residentialListRent;
                int count=0;
                while(fscanf(file, "%s", &residentialListRent)!=EOF)
                {
                    count++;
                }
                fclose(file);
                count=count/20;
                //i disived them to 20 because every person has 20 lines informations
                printf("There is %d residential property.\n", count);
            }
            if(xxChoice==2)
            {
                char n[] = "ResidentialPropertyListForRent.txt";
                struct  residentialListRent *head;
                head=readResidentialListForRentFromFile(n);
                //this is the pointer and link list that is saved in readResidentialListForRentFromFile
                char maxPriceResRent[30];
                printf("Enter the maximum price: ");
                scanf("%s", maxPriceResRent);
                showPropertiesUnderPriceForRent(head, maxPriceResRent);
            }
            if(xxChoice==3)
            {
                char m[] = "ResidentialPropertyListForRent.txt";
                struct  residentialListRent *head;
                head=readResidentialListForRentFromFile(m);
                //this is the pointer and link list that is saved in readResidentialListForRentFromFile
                char infrastructureCheckRent[10];
                printf("Enter infrastructure: ");
                scanf("%s", infrastructureCheckRent);
                showPropertiesInfrastructureCheckForRent(head, infrastructureCheckRent);
            }
            if(xxChoice==4)
            {
                char h[] = "ResidentialPropertyListForRent.txt";
                struct  residentialListRent *head;
                head=readResidentialListForRentFromFile(h);
                //this is the pointer and link list that is saved in readResidentialListForRentFromFile
                char districtCheckRent[10];
                printf("Enter District: ");
                scanf("%s", districtCheckRent);
                showPropertiesDistrictCheckRent(head, districtCheckRent);
            }
            if(xxChoice==5)
            {
                char s[] = "ResidentialPropertyListForRent.txt";
                struct  residentialListRent *head;
                head=readResidentialListForRentFromFile(s);
                //this is the pointer and link list that is saved in readResidentialListForRentFromFile
                char bedroomCheckRent[10];
                printf("Enter the Bedrooms: ");
                scanf("%s", bedroomCheckRent);
                showPropertiesBedroomCheckRent(head, bedroomCheckRent);
            }
            if(xxChoice==6)
            {
                char u[] = "ResidentialPropertyListForRent.txt";
                struct  residentialListRent *head;
                head=readResidentialListForRentFromFile(u);
                //this is the pointer and link list that is saved in readResidentialListForRentFromFile
                char floorCheckRent[10];
                printf("Enter the Floor: ");
                scanf("%s", floorCheckRent);
                showPropertiesFloorCheckRent(head, floorCheckRent);
            }
        }
        if(pChoice==5)
        {
            printf("Reportage of Commercial properties for rent. (Please enter the maximum amount):");
            printf("\n\n1.The number of the Commercial properties.");
            printf("\n2.List based on price");
            printf("\n3.List based on infrastructure");
            printf("\n4.List based on District");
            ...
            if(ssChoice==1)
            {
                ...
                struct commercialListRent commercialListRent;
                int count=0;
                while(fscanf(file, "%s", &commercialListRent)!=EOF)
                {
                    count++;
                }
                fclose(file);
            ...
            if(ssChoice==2)
            {
                char q[] = "CommercialPropertyListForRent.txt";
                struct  commercialListRent *head;
                head=readCommercialListFromFileRent(q);
                //this is the pointer and link list that is saved in readCommercialListFromFileRent
                char maxPriceComRent[30];
                printf("Enter the maximum price: ");
                scanf("%s", maxPriceComRent);
                showPropertiesUnderPriceComRent(head, maxPriceComRent);
            }
            if(ssChoice==3)
            {
                char r[] = "CommercialPropertyListForRent.txt";
                struct  commercialListRent *head;
                head=readCommercialListFromFileRent(r);
                //this is the pointer and link list that is saved in readCommercialListFromFileRent
                char infrastructureCheckComRent[10];
                printf("Enter infrastructure: ");
                scanf("%s", infrastructureCheckComRent);
                showPropertiesInfrastructureCheckComRent(head, infrastructureCheckComRent);
            }
            if(ssChoice==4)
            {
                char t[] = "CommercialPropertyListForRent.txt";
                struct  commercialListRent *head;
                head=readCommercialListFromFileRent(t);
                //this is the pointer and link list that is saved in readCommercialListFromFileRent
                char districtCheckComRent[10];
                printf("Enter District: ");
                scanf("%s", districtCheckComRent);
                showPropertiesDistrictCheckComRent(head, districtCheckComRent);
            }
            if(ssChoice==5)
            {
                char j[] = "CommercialPropertyListForRent.txt";
                struct  commercialListRent *head;
                head=readCommercialListFromFileRent(j);
                //this is the pointer and link list that is saved in readCommercialListFromFileRent
                char shopCheckRent[10];
                printf("Enter the Bedrooms: ");
                scanf("%s", shopCheckRent);
                showPropertiesShopCheckRent(head, shopCheckRent);
            }
            if(ssChoice==6)
            {
                char o[] = "CommercialPropertyListForRent.txt";
                struct  commercialListRent *head;
                head=readCommercialListFromFileRent(o);
                //this is the pointer and link list that is saved in readCommercialListFromFileRent
                char floorCheckComRent[10];
                printf("Enter the Floor: ");
                scanf("%s", floorCheckComRent);
                showPropertiesFloorCheckComRent(head, floorCheckComRent);
            }
        ...
        if(pChoice==6)
        {
            ...
            if(hhChoice==1)
            {
                ...
                struct countrylandListRent countrylandListRent;
                int count=0;
                while(fscanf(file, "%s", &countrylandListRent)!=EOF)
                {
                    count++;
                }
                fclose(file);
            ...
            if(hhChoice==2)
            {
                char w[] = "CountryLandPropertyListForRent.txt";
                struct  countrylandListRent *head;
                head=readCountryLandFromFileRent(w);
                //this is the pointer and link list that is saved in readCountryLandFromFileRent
                char maxPriceCouRent[30];
                printf("Enter the maximum price: ");
                scanf("%s", maxPriceCouRent);
                showPropertiesUnderPriceCouRent(head, maxPriceCouRent);
            }
            if(hhChoice==3)
            {
                char y[] = "CountryLandPropertyListForRent.txt";
                struct  countrylandListRent *head;
                head=readCountryLandFromFileRent(y);
                //this is the pointer and link list that is saved in readCountryLandFromFileRent
                char infrastructureCheckCouRent[10];
                printf("Enter infrastructure: ");
                scanf("%s", infrastructureCheckCouRent);
                showPropertiesInfrastructureCheckCouRent(head, infrastructureCheckCouRent);
            }
            if(hhChoice==4)
            {
                char i[] = "CountryLandPropertyListForRent.txt";
                struct  countrylandListRent *head;
                head=readCountryLandFromFileRent(i);
                //this is the pointer and link list that is saved in readCountryLandFromFileRent
                char districtCheckCouRent[10];
                printf("Enter District: ");
                scanf("%s", districtCheckCouRent);
                showPropertiesDistrictCheckCouRent(head, districtCheckCouRent);
            }
            if(hhChoice==5)
            {
                char l[] = "CountryLandPropertyListForRent.txt";
                struct  countrylandListRent *head;
                head=readCountryLandFromFileRent(l);
                //this is the pointer and link list that is saved in readCountryLandFromFileRent
                char harvestCheckRent[10];
                printf("Enter the Harvest: ");
                scanf("%s", harvestCheckRent);
                showPropertiesHarvestCheckRent(head, harvestCheckRent);
            }
